...
M --> a b
```
The percent symbols indicate where to apply a transformation
...
Note that some older versions of Rustlr attached different types of semantic
values to wildcards.  These should now be considered deprecated.
